  ...
  const mergeServerUser = (serverUser, marketPayload) => {
    ...
    const restoreClientGameSnapshot = (snapshot) => {
      ...
      setGame({
        ...INITIAL,
        ...snapshot,
        player: { ...INITIAL.player, ...(snapshot.player || {}) },
        ...
        factoryState: {
          ...
          ownedFactories: Array.isArray(snapshot.factoryState?.ownedFactories)
            ? snapshot.factoryState.ownedFactories
            : INITIAL.factoryState.ownedFactories,
          shipments: Array.isArray(snapshot.factoryState?.shipments)
            ? snapshot.factoryState.shipments
            : INITIAL.factoryState.shipments,
          stock: { ...INITIAL.factoryState.stock, ...(snapshot.factoryState?.stock || {}) },
        },
      });
    };
